...
class DashboardObatmasukController extends Controller
{
    public function index(Request $request){
        ...
        return view('Dashboard.DataObatMasuk.index', compact('obatmasuk', 'hargamasuk'));
    }



    public function cetak(){
        return view ('Dashboard.DataObatMasuk.cetak',);
    }
    ...
    public function tambah(){
        ...
        return view('Dashboard.DataObatMasuk.tambah', compact('kd'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect('/dashboard/obatmasuk');
    }

    public function hapus($kode_om){
        DB::table('obatmasuk')->where('kode_om',$kode_om)->delete();
        Alert::success('Di Hapus','Data Obat Masuk Telah Di Hapus');
        return redirect('/dashboard/obatmasuk');
    }
