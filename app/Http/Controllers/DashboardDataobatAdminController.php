...
class DashboardDataobatAdminController extends Controller
{
    public function index(Request $request){
        ...
        $beli = DB::table('obat')->sum('harga_beli');
        $jual = DB::table('obat')->sum('harga_jual');

        return view('Dashboard.DataObat.index2',compact('obat','beli','jual'));
    }
    ...
    public function tambah(){
        ...
        return view('Dashboard.DataObat.tambahadmin', compact('kd'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect('/admin/dataobat');
    }

    public function edit($kode_obat){
        $obat = DB::table('obat')->where('kode_obat',$kode_obat)->get();
        return view('Dashboard.DataObat.editadmin',['obat'=>$obat]);
    }
