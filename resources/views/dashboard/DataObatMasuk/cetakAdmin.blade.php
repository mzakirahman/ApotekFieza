...
<a href="/admin/obatmasuk" class="btn btn-success mb-3"><span data-feather="arrow-left-circle"></span></a>
...
<div class="col-lg-8">
    ...
    <br><br>
    <a href="" onclick="this.href='/admin/obatmasuk/cetakPertanggal/'+ document.getElementById('tglAwal').value + '/' + document.getElementById('tglAkhir').value" target="_blank"
