...
<div class="col-lg-8">
    ...
    <br><br>
    <a href="" onclick="this.href='/dashboard/obatkeluar/cetakPertanggal/'+ document.getElementById('tglAwal').value + '/' + document.getElementById('tglAkhir').value" target="_blank"
