...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 mb-3 border-bottom">
  <h1 class="h2">Cetak Laporan Obat Keluar</h1>
</div>
<a href="/admin/obatkeluar" class="btn btn-success mb-3"><span data-feather="arrow-left-circle"></span></a>
...
<div class="col-lg-8">
    ...
    <br><br>
    <a href="" onclick="this.href='/admin/obatkeluar/cetakPertanggal/'+ document.getElementById('tglAwal').value + '/' + document.getElementById('tglAkhir').value" target="_blank"
