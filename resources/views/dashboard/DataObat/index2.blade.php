...
<style type="text/css">
    ...
    <a href="/admin/dataobat/tambah" class="btn btn-success mb-3 tambah"><span data-feather="plus"></span></a>
    <div class="row justify-content-end">
            <div class="col-md-3">
              <form action="/admin/dataobat" method="GET">
      ...
      <br><br>   
          ...
          <tbody>
            @foreach($obat as $o)
              ...
              <td>{{ $o->kode_obat }}</td>
                ...
                <td>{{ $o->satuan }}</td>
                <td>
                  <a href="/admin/dataobat/editdo/{{$o->kode_obat}}" class="badge bg-warning"><span data-feather="edit"></a>
                  | 
                  <a href="/admin/dataobat/hapusdo/{{$o->kode_obat}}" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#hapus{{ $o->kode_obat }}"><span data-feather="trash-2"></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="/admin/dataobat/hapusdo/{{$o->kode_obat}}" class="btn btn-danger">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {{ $obat->links() }}
        <br><br>
        <a href="/admin/dataobat/cetak" target="_blank" class="btn btn-success mb-3 cetak"><span data-feather="printer"></span></a>
      </div>
